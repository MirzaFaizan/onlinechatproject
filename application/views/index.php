...
<head>
	...
	<!-- [ FONT-AWESOME ICON ] 
        =========================================================================================================================-->
	<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/library/font-awesome-4.3.0/css/font-awesome.min.css">
 ...
 ============================================================================================================================--> 
   <section class="main-heading" id="home">
       <div class="overlay">
        ...
        <div class="btn-bar">
          <a href="<?php echo base_url();?>Login_Controller/login" class="btn btn-custom theme_background_color">Ge Started</a>
        ...
        <div class="row">
          <div class="col-sm-4 port-item margin-bottom">
            <div class="item-img-wrap">
              <img src="<?php echo base_url(); ?>assets/images/work-1.jpg" class="img-responsive" alt="workimg">
              <div class="item-img-overlay">
                <a href="<?php echo base_url(); ?>assets/images/work-1.jpg" class="show-image">
                  <span></span>
                </a>
              </div>
            </div>
          ...
          <div class="col-sm-4 port-item margin-bottom">
            <div class="item-img-wrap">
              <img src="<?php echo base_url(); ?>assets/images/work-2.jpg" class="img-responsive" alt="workimg">
              <div class="item-img-overlay">
                <a href="<?php echo base_url(); ?>assets/images/work-2.jpg" class="show-image">
                  <span></span>
                </a>
              </div>
            </div>
          ...
          <div class="col-sm-4 port-item margin-bottom">
            <div class="item-img-wrap">
              <img src="<?php echo base_url(); ?>assets/images/work-3.jpg" class="img-responsive" alt="workimg">
              <div class="item-img-overlay">
                <a href="<?php echo base_url(); ?>assets/images/work-3.jpg" class="show-image">
                  <span></span>
                </a>
              </div>
            </div>
  ...
  <section class="our-team white-background black" id="three">
      <div class="container">
       <div class="row text-center">
          ...
          <div class="row text-center">
          <div class="col-sm-3">
            <img src="<?php echo base_url(); ?>assets/images/team-1.jpg" alt="team-member" class="img-responsive">
            <h4>Ramshad Smith</h4>
            <h5>Founder</h5>
          ...
          <div class="col-sm-3">
            <img src="<?php echo base_url(); ?>assets/images/team-2.jpg" alt="team-member" class="img-responsive">
            <h4>Meera Deo</h4>
            <h5>Web Designer</h5>
          ...
          <div class="col-sm-3">
            <img src="<?php echo base_url(); ?>assets/images/team-3.jpg" alt="team-member" class="img-responsive">
            <h4>Ramkumar Deo</h4>
            <h5>Manager</h5>
          ...
          <div class="col-sm-3">
            <img src="<?php echo base_url(); ?>assets/images/team-4.jpg" alt="team-member" class="img-responsive">
     ...
     <div class="overlay">
         <div class="container">
            ...
            <div class="intermediate-container">
              ...
              <div class="">
                <a class="btn btn-custom-outline" href="<?php echo base_url();?>Login_Controller/login"><span>get started</span></a>
              </div>
            </div>
          </article>
             </div>
