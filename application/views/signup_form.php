                   ...
                   <div class="row">
					<div class="col-md-3 col-sm-3"></div>
					  <div class="col-md-6 center-block col-sm-6 ">
						<?php echo form_open('Signup_Controller');?>
						...
						<p style="color: red;[-=">
                         ...
                         <div class="col-md-6">
                           ...
                           <div class="col-md-6">
                            ...
                            <a href="<?php echo base_url();?>Login_Controller/login">Login</a> <br>
                            <button type="submit" class="btn btn-custom-outline"> Signup </button></center>
                        </div>
						<?php echo form_close(); ?>
					  </div>
					</div> <!-- End of form -->
